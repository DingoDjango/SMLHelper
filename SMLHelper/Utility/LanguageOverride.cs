namespace SMLHelper.V2.Utility
{
    ...
    internal class LanguageOverride
    {
        ...
        internal static void HandleLanguageOverrides(Dictionary<string, string> customLines)
        {
            ...
            ReadOverrideCustomLines(customLines);
        }

        internal static void AddOriginalLanguageLine(string modAssemblyName, string lineId, string text)
        {
        ...
        private static void ReadOverrideCustomLines(Dictionary<string, string> customLines)
        {
            ...
            foreach (string file in files)
            {
                ...
                foreach (string line in languageLines)
                {
                    ...
                    customLines[key] = value; // Override language line
                    overridesApplied++;
                }
